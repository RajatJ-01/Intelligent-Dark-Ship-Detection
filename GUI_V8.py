...
def process_images(image_paths, label_display, tree):
    ...
    from second_script import visualize_ship_paths 
    visualize_ship_paths(dark_ship_index) 
    return dark_ship_index  
...
def select_images(label_display, tree):
    ...
    if file_paths:
        ...
        detected_dark_ship_index = process_images(file_paths, label_display, tree)

        
        further_processing_with_dark_ship(detected_dark_ship_index)


def further_processing_with_dark_ship(dark_ship_index):
    if dark_ship_index is not None:
        print(f"Further processing with Dark Ship {dark_ship_index}...") 
    else:
        print("No dark ship detected.")
